...
{
	float a1_axial_ratio,a1_t_power, a1_reflect_coef, a2_axial_ratio, a2_r_sensitivity, a2_reflect_coef;
	a1_axial_ratio = a1_other[0];
	a1_t_power = a1_other[1];
	a1_reflect_coef = a1_other[2];

	a2_axial_ratio = a2_other[0];
	a2_r_sensitivity = a2_other[1];
	a2_reflect_coef = a2_other[2];

	// build matrix representations
	fmat34 a1_mat, v1_mat, a2_mat, v2_mat;
	...
	float a1_from_a2_vec[3], a2_from_a1_vec[3],a1_pol_in_a2_vec[3];
					  ...
					  const float a1_wavelength, const fvec3 a1_other, const fvec3 a2_other )
{
	...
	signal_strength = signalStrength(a1_pos_vec, v1_pos_vec, a2_pos_vec,
				 	   v2_pos_vec,  a1_rot_vec,  v1_rot_vec,  a2_rot_vec,  v2_rot_vec,  a1_pol_vec,
					   a2_pol_vec, a1_gain_data, a2_gain_data, a1_wavelength,  a1_other, a2_other );
		   ...
		   const fvec3 a2_pol_vec, const float a2_axial_ratio )
{
	...
	temp = (a1_pol_in_a2_vec[0] * a2_pol_vec[0] + a1_pol_in_a2_vec[1] * a2_pol_vec[1] +	a1_pol_in_a2_vec[2] * a2_pol_vec[2]);
